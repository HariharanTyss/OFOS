...
public class TC015_VerifyOrderContinentalDishThrough_RestrauntFeature extends Base_Test
{

	@Test()
	public void OrderContinentalDishThrough_RestrauntFeature   () throws Throwable  
	{
		...
		jsu.jsClick(hp.getContinentalLink());
		Thread.sleep(2000);
